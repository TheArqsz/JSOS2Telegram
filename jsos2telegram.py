...
from helpers import (
    clean_driver, delete_screenshot, is_driver_working, make_screenshot, send_debug_message_by_tg,
    ...
    def loop(self):
        ...
        try:
            ...
            if is_driver_working(driver=self.driver) and e.__class__ is not CredentialsError:
                ...
                send_debug_message_by_tg(message=f"Error {e} occured", t="ERROR")
